    ...
    <div className="bg-scout-verde/5 min-h-screen">
      ...
      <div className="text-center mb-8">
        <div className="flex justify-center items-center mb-3">
          <div className="bg-scout-azul h-10 w-10 rounded-full flex items-center justify-center mr-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <h2 className="text-3xl font-bold text-scout-azul">Onde Estamos</h2>
        </div>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Visite-nos na nossa sede para conhecer melhor o nosso grupo. Estamos
          localizados no centro do Funchal, num local de fácil acesso.
        </p>
      </div>
      <GrupoMaps />
      {/* Schema.org para SEO */}
