export default function Home() {
  return (
    <section>
      ...
      <p>
        Embora não haja informações detalhadas sobre a data exata de fundação do
        Grupo 92, sabe-se que, entre 1982 e 1984, houve um esforço significativo
        para expandir o escotismo na Madeira, resultando na formação de vários
        grupos, incluindo o Grupo 92.
      </p>
      ...
      <p>
        O Grupo 92 continua a ser uma parte integrante desta tradição escotista
        na Madeira, contribuindo para o desenvolvimento de crianças e jovens
        através de atividades que promovem valores como a responsabilidade, o
        companheirismo e o serviço à comunidade.
      </p>
    </section>
  );
}
